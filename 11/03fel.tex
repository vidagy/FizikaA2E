\feladat{3}{Egy váltóáramú generátorban $l=10$\,cm élhosszúságú, négyzet alakú keretet forgatunk $B=0,8$\,T erősségű mágneses térben úgy, hogy a forgástengely merőleges a mágneses indukció vektorára. A forgás frekvenciája $f=50\me{Hz}$. 
\begin{enumerate}[label=\alph*),itemsep=0pt]
 ...
 \item Ha a keret ellenállása $R=1\me{\Omega}$, hogyan változik a benne folyó áram az idő függvényében?
\end{enumerate}
}{03fel_01fig}{}
