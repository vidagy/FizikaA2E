\feladat{2}{
 Négyzet alakú, $l=0,4\,\textrm{m}$ élhosszúságú vezető keretben $I=10\, \textrm{A}$ erősségű áram folyik. Számítsuk ki a mágneses tér nagyságát és irányát a keret középpontjában!
}{}{}
...
\ifdefined\megoldas
 ...
 \al{
  \sin\alpha_\text{h}
   =\frac{\frac{a}{2}}{\left(d^2+\frac{a^2}{4}\right)^\frac{1}{2}}\;.
 }
 ...
 \al{
  ...
  \\
   &=\frac{\mu_0 I}{2\pi d}\frac{\frac{a}{2}}{\left(d^2+\frac{a^2}{4}\right)^\frac{1}{2}}\;,
 }
